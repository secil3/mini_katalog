...
class _AnaEkranState extends State<AnaEkran> {
  ...
  void sepeteEkle(Urun urun) => setState(() => sepet.add(urun));
  void sepettenCikar(int index) => setState(() => sepet.removeAt(index));

  @override
  Widget build(BuildContext context) {
    final sayfalar = [
      AnaSayfa(sepeteEkle: sepeteEkle),
      SepetSayfasi(sepet: sepet, sepettenCikar: sepettenCikar),
    ];
